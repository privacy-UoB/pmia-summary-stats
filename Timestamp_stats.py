...
cosine = False
cosine_simularity_graphs = False
...
if cosine_simularity_graphs == True:
...
if correlation == True:
    pop_df, pool_df, statistics, independent_columns = independent(pop_timestamps_graph, pool_timestamps_graph, print_independent_miRNAs=True)
print (pop_df, pool_df)