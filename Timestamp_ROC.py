...
pvalue_pop_L1 = L1_ttest(ti_pop[1], pop, pool)
pvalue_pool_L1 = L1_ttest(ti_pool[1], pop, pool)
pvalue_pop_LLR = LLR(ti_pop[1], pop, pool)
pvalue_pool_LLR = LLR(ti_pool[1], pop, pool)
